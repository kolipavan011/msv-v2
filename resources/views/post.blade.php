                ...
                <article class="col" id="post-{{$video->id}}">
                    <div class="card h-100">
                        <div class="video-container">
                            <video style="background-color: #ccc;" id="video-{{$video->id}}" class="w-100 card-img-top lazy" width="360" height="260" src="{{ url($video->path) }}" data-poster="{{ url($video->thumbnail) }}" preload="none"></video>
